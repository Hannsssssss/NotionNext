...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的网站🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '资库网', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '免费的资自学资源宝库', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ziikuu.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ziikuu, 资源', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Hannsssssss@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'article/%postname%/%post_id%/',
